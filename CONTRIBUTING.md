...
# Clone your fork
git clone git@github.com:<your-username>/vite-plugin-sdk.git
...
## `vite-plugin-sdk` in Prismic's Open-Source Ecosystem
...
[repo-issue]: https://github.com/prismicio-community/vite-plugin-sdk/issues/new/choose
